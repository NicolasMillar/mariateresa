                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="column" style="width: 50%; justify-content: right; display:flex" >
                            <a href="{{route('admin.asignatura.index')}}" id="volver">Todos Los Asignaturas</a>
                        </div>
                    </div>
                </div>
                <div class="panel-body" style="justify-content: center; display: flex">
                    <div class="card">
                        <div class="card-body" style="background-color: lightblue">
                            {!! Form::model($asignatura, ['route' => ['admin.asignatura.update', $asignatura], 'method'=>'put', 'enctype'=>'multipart/form-data']) !!}
