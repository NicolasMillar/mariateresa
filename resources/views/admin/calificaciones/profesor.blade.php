...
@section('Content')
    <div>
        <div style="width: 100%; ">
            <div style="float:left; border: solid blue 1px; width: 15%; justify-content: center; display:flex">
                <button style="background-color:rgba(62, 62, 248, 0.664)" id="boton">Crear Evaluacion</button>
            </div>
            <div style="float:left; border: solid green 1px; width: 70%; justify-content: center; display:flex">
                <button style="background-color:cadetblue" id="boton">Ingresar calificacion</button>
            </div>
            <div style="float:left; border: solid red 1px; width: 15%; justify-content: center; display:flex">
