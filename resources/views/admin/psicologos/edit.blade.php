                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="column" style="width: 50%; justify-content: right; display:flex" >
                            <a href="{{route('admin.psicologo.index')}}" id="volver">Todos Los Alumnos</a>
                        </div>
                    </div>
                </div>
                <div class="panel-body" style="justify-content: center; display: flex">
                    <div class="card">
                        <div class="card-body" style="background-color: lightblue">
                            {!! Form::model($psicologo, ['route' => ['admin.psicologo.update', $psicologo], 'method'=>'put', 'enctype'=>'multipart/form-data']) !!}
                            ...
                            <div class="form-group" style="margin-top: 10px;">
                                ...
                                {!! Form::text('Telefono', $psicologo->Telefono_Contacto, ['class'=>'form-control', 'placeholder'=>'Ingrese el telefono de contacto del psicologo']) !!}
                                @error('Telefono')
                                    <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
                            <div class="form-group" style="margin-top: 10px;">
                                ...
                                {!! Form::text('Especialidad', $psicologo->Especialidad, ['class'=>'form-control', 'placeholder'=>'Ingrese la especialidad del psicologo']) !!}
                                @error('Especialidad')
                                    <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
