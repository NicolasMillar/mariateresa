                ...
                <div class="panel-heading">
                    <div class="row">
                        ...
                        <div class="column" style="width: 50%; justify-content: right; display:flex" >
                            <a href="{{route('admin.noticia.index')}}" id="volver">Todas Las Imagenes</a>
                        </div>
                    </div>
                </div>
                <div class="panel-body" style="justify-content: center; display: flex">
                    <div class="card">
                        <div class="card-body" style="background-color: lightblue">
                            {!! Form::model($noticia, ['route' => ['admin.noticia.update', $noticia], 'method'=>'put', 'enctype'=>'multipart/form-data']) !!}
                                ...
                                <div class="form-group" style="margin-top: 10px;">
                                    ...
                                    {!! Form::textarea('Descripcion', null, ['class'=>'form-control', 'placeholder'=>'Ingrese un texto para la noticia']) !!}
                                </div>
